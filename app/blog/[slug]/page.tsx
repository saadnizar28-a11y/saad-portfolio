    ...
    <main className="min-h-screen pt-40 pb-32 px-6 relative overflow-hidden bg-[var(--background)]">
      ...
      <div className="max-w-4xl mx-auto relative z-10 box-border">
        ...
        <FadeIn delay={300} className="glass-card rounded-2xl p-8 md:p-16 border border-white/5 relative overflow-hidden">
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex items-center gap-4 opacity-60 hover:opacity-100 transition-opacity duration-500 relative z-10">
            ...
            <div>
              <p className="text-xs text-white font-bold tracking-widest uppercase mb-0.5">Written by <Link href="/" className="hover:text-[var(--accent-cyan)] transition-colors">Saad Nizar</Link></p>
              <p className="text-[10px] text-white/50 tracking-wider">
                Looking for a UAE-focused <Link href="/" className="text-[var(--accent-cyan)] hover:underline">digital marketing strategist</Link>? Visit Saad Nizar.
              </p>
            </div>
          </div>
        </FadeIn>
