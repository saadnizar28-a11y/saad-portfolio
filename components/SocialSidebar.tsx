    ...
    <div className="fixed right-4 md:right-8 top-1/2 -translate-y-1/2 z-50 pointer-events-auto mix-blend-screen">
      ...
      <div className="relative w-16 h-16 flex items-center justify-center group">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 opacity-0 scale-50 pointer-events-none group-hover:pointer-events-auto group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
          ...
          {/* LinkedIn - Cyan */}
          <Link href="https://www.linkedin.com/in/saad-nizarudeen-694624175/" target="_blank" aria-label="LinkedIn Profile" className="group/link block">
          ...
          {/* WhatsApp - Green */}
          <Link href="https://wa.me/971523887970" target="_blank" aria-label="WhatsApp Contact" className="group/link block">
          ...
          <Link href="https://www.instagram.com/waura_ai?igsh=enZuMmRmNTFxcWow" target="_blank" aria-label="Instagram Profile" className="group/link block">
